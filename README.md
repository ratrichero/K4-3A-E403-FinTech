...
**Lớp:** 3A · **Phòng:** E403 · **Cụm:** 1 · **Track:** A — VLearn Tutor (A2 · Class Confusion Copilot)
...
| **Dương Đạt Khang** | `2A0202602624` | **Data Scientist / UX** | Khai phá dữ liệu 13.494 logs, thuật toán tính điểm nhiệt tất định (`tools.py`), Xây dựng bộ Golden Set 20 cases, Validation log R6,Phỏng vấn kiểm chứng Willing Users |
...
| **Nguyễn Thị Chinh** | `2A0202602876` | **Algorithm** | Nghiên cứu bài toán & Thiết kế công thức Heat Score 2D (Breadth-Depth) ([branch `chinh`](https://github.com/ratrichero/K4-3A-E403-FinTech/tree/chinh/codebase): [`pedagogical_heat_engine.py`](https://github.com/ratrichero/K4-3A-E403-FinTech/blob/chinh/codebase/pedagogical_heat_engine.py), [`benchmark_heat_comparison.py`](https://github.com/ratrichero/K4-3A-E403-FinTech/blob/chinh/codebase/benchmark_heat_comparison.py)), dựng Working Prototype CP3 |
